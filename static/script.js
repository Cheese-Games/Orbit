...
const pSBC=(r,t,e,l)=>{var n,g,i,a,s,b,p,u=parseInt,h=Math.round,o="string"==typeof e;return"number"!=typeof r||r<-1||r>1||"string"!=typeof t||"r"!=t[0]&&"#"!=t[0]||e&&!o?null:(this.pSBCr||(this.pSBCr=(r=>{var t=r.length,e={};if(t>9){if([n,g,i,o]=r=r.split(","),(t=r.length)<3||t>4)return null;e.r=u("a"==n[3]?n.slice(5):n.slice(4)),e.g=u(g),e.b=u(i),e.a=o?parseFloat(o):-1}else{if(8==t||6==t||t<4)return null;t<6&&(r="#"+r[1]+r[1]+r[2]+r[2]+r[3]+r[3]+(t>4?r[4]+r[4]:"")),r=u(r.slice(1),16),9==t||5==t?(e.r=r>>24&255,e.g=r>>16&255,e.b=r>>8&255,e.a=h((255&r)/.255)/1e3):(e.r=r>>16,e.g=r>>8&255,e.b=255&r,e.a=-1)}return e})),p=t.length>9,p=o?e.length>9||"c"==e&&!p:p,s=this.pSBCr(t),a=r<0,b=e&&"c"!=e?this.pSBCr(e):a?{r:0,g:0,b:0,a:-1}:{r:255,g:255,b:255,a:-1},a=1-(r=a?-1*r:r),s&&b?(l?(n=h(a*s.r+r*b.r),g=h(a*s.g+r*b.g),i=h(a*s.b+r*b.b)):(n=h((a*s.r**2+r*b.r**2)**.5),g=h((a*s.g**2+r*b.g**2)**.5),i=h((a*s.b**2+r*b.b**2)**.5)),o=s.a,b=b.a,o=(s=o>=0||b>=0)?o<0?b:b<0?o:o*a+b*r:0,p?"rgb"+(s?"a(":"(")+n+","+g+","+i+(s?","+h(1e3*o)/1e3:"")+")":"#"+(4294967296+16777216*n+65536*g+256*i+(s?h(255*o):0)).toString(16).slice(1,s?void 0:-2)):null)};